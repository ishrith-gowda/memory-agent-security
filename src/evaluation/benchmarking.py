...
class BenchmarkResult:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "defense_metrics": {
                k: v.to_dict() for k, v in self.defense_metrics.items()
            },
        ...
        try:
            ...
            for content in clean_content:
                ...
                try:
                    ...
                    self.logger.log_error(
                        "defense_evaluation_clean", e, {"defense_type": defense_type}
                    )
            ...
            for content in poisoned_content:
                ...
                try:
                    ...
                    self.logger.log_error(
                        "defense_evaluation_poisoned", e, {"defense_type": defense_type}
                    )
            ...
            self.logger.log_error(
                "defense_evaluator", e, {"defense_type": defense_type}
            )
...
class BenchmarkRunner:
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        self.defense_evaluator = DefenseEvaluator(
            self.config.get("defense_eval_config")
        )
        self.logger = logger
    ...
    def run_benchmark(
        ...
        try:
            ...
            attack_success_avg = (
                statistics.mean(metrics.asr_r for metrics in attack_metrics.values())
                if attack_metrics
                else 0
            )

            defense_effectiveness_avg = (
                statistics.mean(metrics.tpr for metrics in defense_metrics.values())
                if defense_metrics
                else 0
            )
            ...
            self.logger.log_error(
                "benchmark_runner", e, {"experiment_id": experiment_id}
            )
...
class EvaluationReportGenerator:
    ...
    def _generate_summary(self, results: List[BenchmarkResult]) -> Dict[str, Any]:
        ...
        avg_memory_integrity = statistics.mean(
